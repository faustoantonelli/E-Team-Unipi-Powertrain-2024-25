...
for i = 2:num_points-1
    ...
    steeringAngles(i) = atan(vp.l / radiusCurvature(i)) * sign(curvature(i)); % Angolo di sterzata
    ...
    brakeForce(i) = max(0, massVehicle * (vehicleSpeed(i-1) - vehicleSpeed(i)) / dt); % Forza frenante
    brakeForce(i) = min(brakeForce(i), massVehicle * mu * g); % Limita la forza frenante all'aderenza massima
